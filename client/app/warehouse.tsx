  ...
  return (
    <SafeAreaView className="flex-1 bg-[#1a1f3a]">
      <View className="flex-1">
        {/* Top Orange-Brown Section */}
        <View className="bg-[#ea580c] pb-8 rounded-b-3xl">
          ...
          <View className="items-center pt-12 pb-6">
            ...
            <Text className="text-white text-3xl font-bold mb-2">Warehouse Login</Text>
            <Text className="text-gray-200 text-base">Access staff dashboard</Text>
          </View>
        </View>
